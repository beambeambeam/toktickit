...
| UI-07 | UI component/regression | client/tests/lab-02/create-ticket.test.tsx; my-tickets.test.tsx; ticket-detail.test.tsx; client/tests/lab-03/public-comments.test.tsx | Adapt existing tests to authenticated identity; preserve fields/files, query defaults, ownership/retry; add public comment/indication interactions. | Partial — authenticated requester regressions and public comment states pass; indication remains planned |
...
| E2E-03 | E2E | e2e/lab-03/staff-ticket-flow.spec.ts; e2e/lab-03/staff-queue.spec.ts; e2e/lab-03/public-comments.spec.ts | Queue/detail, claim/priority, status/reopen/indication, public Requester-staff conversation, private staff/admin-only notes and terminal denial. | Partial — #51 queue-to-detail and #54 Requester-staff conversation journeys are covered; remaining operational slices are planned |
