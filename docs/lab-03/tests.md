...
| UI-06 | UI component | client/tests/lab-03/user-management.test.tsx | List/search/create, validation, duplicate value retention, loading/empty/no-results/Retry/saving/success, API-forbidden denial/cache clearing and password-required routing. Edit/reset and lifecycle admin-safety states remain planned. | Partial — #56 list/create coverage passes: 13 tests; lifecycle modes remain planned |
...
| E2E-03 | E2E | e2e/lab-03/staff-queue.spec.ts; e2e/lab-03/ticket-workflow.spec.ts; e2e/lab-03/ticket-ownership.spec.ts; e2e/lab-03/staff-ticket-flow.spec.ts; e2e/lab-03/public-comments.spec.ts | Queue/detail, claim/priority, status/reopen/indication, public Requester-staff conversation, private staff/admin-only notes and terminal denial. | Partial — #51 queue-to-detail, #52 claim/priority, #53 workflow, and #54 Requester-staff conversation journeys are covered; remaining operational slices are planned |
| E2E-03 | E2E | e2e/lab-03/staff-queue.spec.ts; e2e/lab-03/ticket-workflow.spec.ts; e2e/lab-03/ticket-ownership.spec.ts; e2e/lab-03/staff-ticket-flow.spec.ts; e2e/lab-03/public-comments.spec.ts; e2e/lab-03/internal-notes.spec.ts | Queue/detail, claim/priority, status/reopen/indication, public Requester-staff conversation, private staff/admin-only notes and terminal denial. | Partial — #51 queue-to-detail, #52 claim/priority, #53 workflow, #54 Requester-staff conversation, and #55 private-note journeys are covered; remaining operational slices are planned |
| E2E-04 | E2E | e2e/lab-03/user-management.spec.ts | Create-to-first-login is implemented. Reset-to-first-login, edit access, deactivate, revoked access and lifecycle admin guards remain planned. | Partial — create-to-first-login test added; browser/database execution pending |
