...
| UI-05 | UI component | client/tests/lab-03/staff-ticket-detail.test.tsx | Read-only operational detail, active/removed Attachment states, download, invalid-ID and retry failures; workflow controls and later operational composers. | Partial — #53 status workflow interaction passes; ownership, comments, notes and indication remain planned |
...
| E2E-03 | E2E | e2e/lab-03/staff-queue.spec.ts; e2e/lab-03/ticket-workflow.spec.ts; e2e/lab-03/staff-ticket-flow.spec.ts | Queue/detail, claim/priority, status/reopen/indication, public Requester-staff conversation, private staff/admin-only notes and terminal denial. | Partial — #51 queue-to-detail and #53 workflow journeys are implemented; later operational actions remain planned |
